              ...
              return (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h3 className={`text-base font-serif font-bold leading-tight ${isSelected ? 'text-white' : 'text-slate-200'}`}>
                      {pillar.title}
                    </h3>
            ...
            <div className="relative rounded-3xl p-6 sm:p-8 glass-panel border border-purple-400/30 bg-gradient-to-br from-[#182138]/90 via-[#141B2E]/90 to-[#101524] shadow-2xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                ...
                <div className="md:col-span-8 space-y-4">
                  ...
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-400/10 border border-amber-400/30 text-amber-300 text-xs font-medium tracking-wide">
