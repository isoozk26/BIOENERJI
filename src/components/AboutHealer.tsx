...
export const AboutHealer: React.FC<AboutHealerProps> = ({ onOpenAppointment }) => {
  return (
    <section id="hakkimda" className="relative py-24 bg-[#07080D] overflow-hidden">
      <div className="w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-12">
        
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          
          {/* Left Column: Healer Portrait & Badges in 600x900 (2:3) */}
          <div className="lg:col-span-5 relative flex justify-center">
            <div className="relative w-full max-w-sm sm:max-w-md">
              {/* Glowing Aura Ring */}
              <div className="absolute -inset-2 bg-gradient-to-tr from-purple-600 via-amber-500 to-cyan-500 rounded-3xl blur-xl opacity-30 animate-pulse-slow"></div>
              
              <div className="relative rounded-3xl overflow-hidden glass-panel border border-purple-500/30 shadow-2xl bg-[#0F121C]">
                ...
                <div className="p-6 bg-gradient-to-t from-[#07080D] via-[#07080D]/95 to-transparent space-y-2">
                  <h3 className="text-xl font-serif font-bold text-white flex items-center justify-between">
                    <span>{SITE_CONFIG.practitioner}</span>
                    <span className="text-xs font-sans font-medium px-2 py-0.5 rounded bg-amber-500/20 text-amber-300 border border-amber-500/30">
                      Uygulayıcı
                    </span>
                  </h3>
                  ...
                  <div className="pt-2 flex items-center gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="text-xs text-slate-300 hover:text-pink-400 flex items-center gap-1.5 transition-colors"
                    >
              ...
              <div className="absolute -bottom-6 right-2 sm:-right-4 max-w-[260px] p-3.5 rounded-2xl bg-[#111526]/95 border border-purple-500/40 shadow-2xl backdrop-blur-xl text-[11px] text-slate-200 italic animate-float">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-amber-950/40 border border-amber-500/30 text-amber-300 text-xs font-semibold">
            ...
            <h2 className="text-3xl sm:text-4xl font-serif font-bold text-white tracking-tight">
              ...
              <span className="bg-gradient-to-r from-amber-200 via-purple-300 to-cyan-200 bg-clip-text text-transparent">
            ...
            <div className="p-6 rounded-2xl glass-panel border border-slate-800 bg-[#0C0F1A]/80 space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-r from-purple-950/70 via-[#121626] to-amber-950/40 border border-purple-500/40 flex flex-col sm:flex-row items-center justify-between gap-4">
